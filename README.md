...
It resolves to the newest release, so it stays correct without ever being edited again, and
it appears in both forms above automatically once `CITATION.cff` carries it.
